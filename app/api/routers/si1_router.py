...
from utils.sub_si1_checker import scan_ifc_basic, check_sector_size_compliance, build_sectors
from utils.SI_1_interior_propagation import load_rules_config
import ifcopenshell
